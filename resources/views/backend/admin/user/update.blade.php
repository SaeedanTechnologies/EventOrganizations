            ...
            <form action="{{route('admin.users.update', $user->id)}}" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="password" class="form-control" name="password" value="{{$user->original_password}}" id="inputPassword4"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" name="phone" value="{{$user->phone}}" id="inputCity" placeholder="Phone"
                            required>
                    </div>
                </div>
